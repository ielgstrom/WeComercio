            ...
            <div className="row">
                ...
                <div className="col-6">
                    ...
                    <div className="estrellasValoracion">
                        {productoSeleccionado[0].estrellas >= 1 && <FaStar />}
                        {productoSeleccionado[0].estrellas <= 1 && (
                            <FaRegStar />
                        )}
                        {productoSeleccionado[0].estrellas >= 2 && <FaStar />}
                        {productoSeleccionado[0].estrellas <= 2 && (
                            <FaRegStar />
                        )}
                        {productoSeleccionado[0].estrellas >= 3 && <FaStar />}
                        {productoSeleccionado[0].estrellas <= 3 && (
                            <FaRegStar />
                        )}
                        {productoSeleccionado[0].estrellas >= 4 && <FaStar />}
                        {productoSeleccionado[0].estrellas <= 4 && (
                            <FaRegStar />
                        )}
                        {productoSeleccionado[0].estrellas >= 5 && <FaStar />}
                    </div>
                    <p className="descripcionProducto">
                        {productoSeleccionado[0].descripción}
                    </p>
                    <div className="row">
                        <div className="col-4 botonAñadirCarrito" type="button">
                            <MdAddShoppingCart /> Añadir al Carrito
                        </div>
                        <div className="col-4 botonAñadirCarrito" type="button">
                            <BiGift /> Comprar Ahora
                        </div>
                    </div>
                </div>
            </div>
